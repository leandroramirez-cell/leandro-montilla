...
export default function HomeScreen({ navigation }) {
  ...
  const sincronizarReceitas = async () => {
    setCarregando(true);
    try {
      const response = await fetch('https://raw.githubusercontent.com/leandroramirez-cell/leandro-montilla/refs/heads/main/receitas.json');
